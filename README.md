# Laravel 10 Mail using Queue & Job

This repository provides an example of a mail using queue and job implemented in Laravel 10.
...
```
composer create-project laravel/laravel queuejob
```
...
### 3. Set up your configuration in .env file
...
To generate mail password follow the below steps

- Login to your gmail account e.g. myaccount.google.com
- Go to Security setting and Enable 2 factor (step) authentication
- After enabling this you can see app passwords option. [Click here](https://myaccount.google.com/apppasswords)
...
resources/views/emails/new-mail.blade.php
```
<!DOCTYPE html>
<html lang="en">
...
### 11. Install Yoeunes toastr package
